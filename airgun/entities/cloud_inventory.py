...
class CloudInventoryEntity(BaseEntity):
    ...
    def get_displayed_buttons(self):
        ...
        result = {
            ...
            "cloud_connector_text": (
                view.cloud_connector.read()
                if view.cloud_connector.is_displayed
                else None
            ),
            ...
            "sync_status_text": view.sync_status.read()
            if view.sync_status.is_displayed
            else None,
        }
        return result
    ...
    def download_report(self, entity_name):
        ...
        view.inventory_list.toggle(entity_name)
        view.browser.click(
            view.inventory_list.generating.download_report, ignore_ajax=True
        )
        time.sleep(3)
