...
class VirtwhoConfigureDetailsView(BaseLoggedInView):
    ...
    class overview(SatTab):
        ...
        hypervisor_server_label = Text(
            __label_template.format(class_name="config-hypervisor_server")
        )
        hypervisor_username_label = Text(
            __label_template.format(class_name="config-hypervisor_username")
        )
        ...
        filter_host_parents_label = Text(
            __label_template.format(class_name="config-filter_host_parents")
        )
        exclude_hosts_label = Text(__label_template.format(class_name="config-blacklist"))
        exclude_host_parents_label = Text(
            __label_template.format(class_name="config-exclude_host_parents")
        )
