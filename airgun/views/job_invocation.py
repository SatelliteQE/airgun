...
from airgun.widgets import PF5DataList, PF5LabeledExpandableSection, SearchInput
...
class JobInvocationsView(BaseLoggedInView, SearchableViewMixin):
    ...
    searchbox = SearchInput(locator='.//div[@class="foreman-search-bar"]//input[@aria-label="Search input"]')
