...
class WebhooksView(BaseLoggedInView, SearchableViewMixinPF4):
    ...
    table = SatTable(
        './/table',
        column_widgets={
            'Name': PF5Button(locator='.//span[@data-ouia-component-id="name-edit-active-button"]'),
...
class WebhookFormView(BaseLoggedInView):
    ...
    # Tab buttons
    general_tab = PF5Button(locator='.//button[@data-ouia-component-id="webhook-form-tab-general"]')
    credentials_tab = PF5Button(
        locator='.//button[@data-ouia-component-id="webhook-form-tab-creds"]'
    )
    additional_tab = PF5Button(locator='.//button[@data-ouia-component-id="webhook-form-tab-add"]')
    ...
    def wait_for_popup(self):
        self.browser.wait_for_element(self.cancel_button, visible=True, timeout=30)
